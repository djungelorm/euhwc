            ...
            (function () {
                ...
                ga.src = <?php
					if ( $this->options['gajslocalhosting'] && !empty( $this->options['gajsurl'] ) ) {
						...
						// Modified by Alex Collins to enable new Google Analytics demographics tracking
						echo "('https:' == document.location.protocol ? 'https://' : 'http://') + 'stats.g.doubleclick.net/dc.js'";
					}
					?>;
