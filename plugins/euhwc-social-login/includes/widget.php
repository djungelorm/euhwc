...
add_action('widgets_init', 'euhwc_social_login_unregister_oa_widget', 100);

/**
 * Customized Social Login Widget
 */
class euhwc_social_login_widget extends WP_Widget {

	/**
	 * Constructor
	 */
  public function __construct () {
		parent::__construct('euhwc_social_login', 'EUHWC Social Login');
  }
  ...
  public function widget ($args, $instance) {
		...
		if (empty ($instance ['widget_hide_for_logged_in_users']) OR !is_user_logged_in ())
		{
			...
			//Content
      echo euhwc_social_login_render_login_form('widget', $instance);
...
add_action('widgets_init', 'euhwc_social_login_register_widget');
